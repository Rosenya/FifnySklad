...
<html lang="pl">
    ...
    <body>
        ...
        <!-- Page content-->
        <form method="post" action='<c:url value="/editProduct/${product.id}"/>'>
        <div class="container">
                ...
                <h1>Edycja produktu</h1>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="id" name="id" value="${product.id}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="productName">Nazwa produktu</label>
                            <input type="name" class="form-control" id="productName" name="name" value="${product.name}" >
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputAddress" name="quantity" value="${product.quantity}">
                    </div>
