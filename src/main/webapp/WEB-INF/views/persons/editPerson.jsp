                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-1">
                                            <label class="radio-inline"><input type="radio"  name="checkbox"
                                                                               value="1" <c:if test="${student.checkbox eq '1'}">checked</c:if>>TAK
                                            </label>
                                        </div>
                                        <div class="col-1">
                                            <label class="radio-inline"><input type="radio"  name="checkbox"
                                                                               value="0" <c:if test="${student.checkbox eq '0'}">checked</c:if>>NIE</label>
                                        </div>
                                    </div>
