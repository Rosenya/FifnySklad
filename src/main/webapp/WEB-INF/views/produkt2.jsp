...
<%@ page contentType="text/html; charset=UTF-8" %>
    <head>
        ...
        <link href="/resources/productvievs/css/styles.css" rel="stylesheet" />
    </head>
    <body>
        <!-- Navigation-->
        ...
        <c:forEach items="${product}" var="title">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    <div class="small mb-1"  name="SKU">${title.SKU}</div>
                    <h1 class="display-5 fw-bolder"  name="name" >${title.name}</h1>
                    <div class="fs-5 mb-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="../../resources/static/gallery/produkt1.jpg" alt="..." />
                            <!-- Product details-->
