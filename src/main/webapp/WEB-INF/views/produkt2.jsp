            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="lead">Zestaw terrazzo to: - marmurkowe naczynka - certyfikowany wosk sojowy bez GMO
                        100g - olejek zapachowy 10ml - zapałki w fiFNEJ buteleczce - ekologiczne płatki róży Wszystko
                        pakujemy w nasze eko pudełko wypełnione delikatną i elegancką bibułą.</p>
                        <div class="d-flex">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Zestaw DIY Terazzo</h5>
                                    <!-- Product price-->
                                    89 zł
                                </div>
                            </div>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">Sprawdź</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
